-- Use this script after installing the prototype with:
--   psql -v ON_ERROR_STOP=1 -f sql/pg_semantic_view--0.1.0.sql
--
-- Unlike examples/demo.sql, this file does not attempt:
...
SELECT semantic.create_view(
    ...
    p_definition => jsonb_build_object(
        'description', 'Revenue model used in demo_snowflake_postgres.sql',
